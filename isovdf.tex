...
technological development better.  In particular, arithmetic for an
isogenies-based VDF appears much more widely useful.
...
Isogenies schemes like CSIDH remain an interesting candidate for small
post-qauntum signatures too.  TODO: Luca SeaSign ???

We sugest arithmetic optimisations, including hardware, that favours
all these use cases together would become more accessible to all users
and better track advancing technologies.
...
for RSA using residue number systems \cite{RNSonGPU07,????}. % https://eprint.iacr.org/2007/187.pdf
...
We expect these reduces confidence in any particular ASIC for RSA
