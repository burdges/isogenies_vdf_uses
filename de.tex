...
\item[Challenge.] The challenger outputs a uniformly random
  $R\in E(\F_p)$ of order $N$, and a uniformly random $Q\in E'[N]$.
...
\begin{proof}
  ...
  same, receiving $R\in E(\F_p)$ of order $N$ and $Q\in E'[N]$. %
  ...
  is necessarily a multiple of $P$, since $E(\F_p)\cap E[N]$ is
  cyclic. %
