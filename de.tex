...
functions that can only be evaluated ``slowly'', but such that
...
This VDF uses chains of supersingular isogenies as ``slow'' function,
and pairings for efficient verification.
...
generically construct Delay Encryption from any of the two.
...
development to evaluate the ``slow'' function quickly, and then produce
the best designs at scale, so that they are available to anyone who
wants to run the extraction. %
